...
function init(domId: string) {
  "use strict";
  var threeD: any = function (param: any) {
    this.transIn = {};
    this.transOut = {};
  ...
  Build.prototype.go = function () {
    ...
    dom.style.backgroundImage =
      "radial-gradient(ellipse farthest-corner at center top, #000d4d 0%, #000105 100%)";
...
export const clearFunc = ()=>{console.log("cancelAnimationFrame");}
window.addEventListener(
  "resize",
  function () {
    canvas.width = window.innerWidth;
