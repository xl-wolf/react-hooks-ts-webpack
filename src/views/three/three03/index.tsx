...
export default () => {
    ...
    const init = () => {
        ...
        setcamera(camera = new Three.PerspectiveCamera(40, WIDTH / HEIGHT, 1, 10000))
        ...
        //
        setcontrols(controls = new TrackballControls(camera, renderer.domElement))
    ...
    const toggleActiveClass = (dom: any) => {
        domArray.forEach((domItem: any) => { domItem.className = '' })
