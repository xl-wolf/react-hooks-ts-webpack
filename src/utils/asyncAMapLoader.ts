  ...
  return new Promise(
    (resolve: (data: any) => void, reject: (data: any) => void) => {
      if (window.AMap) {
         ...
         */
        const url =
          "http://webapi.amap.com/maps?v=1.4.1&key=809dee997bdb4ec644f5545d19bb7543&callback=initAMap&plugin=Map3D,AMap.MarkerClusterer,AMap.Geolocation,AMap.ControlBar";
